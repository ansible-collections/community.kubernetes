...
DOCUMENTATION = '''
module: openshift_v1_route_list
short_description: OpenShift RouteList
description:
- Retrieve a list of routes. List operations provide a snapshot read of the underlying
      ...
      contains:
        ...
        spec:
          ...
          contains:
            alternate_backends:
              description:
              - alternateBackends is an extension of the 'to' field. If more than
                one service needs to be pointed to, then use this field. Use the weight
                field in RouteTargetReference object to specify relative preference.
                If the weight field is zero, the backend is ignored.
              type: list
              contains:
                kind:
                  description:
              ...
              contains:
                ...
                destination_ca_certificate:
                  ...
                  - destinationCACertificate provides the contents of the ca certificate
                    ...
                    checks on the secure connection
                  type: str
            ...
            to:
              ...
              - to is an object the route should use as the primary backend. Only
                ...
                If the weight field is set to zero, no traffic will be sent to this
                service.
              type: complex
              contains:
                kind:
...
def main():
    try:
        module = OpenShiftAnsibleModule('route_list', 'V1')
