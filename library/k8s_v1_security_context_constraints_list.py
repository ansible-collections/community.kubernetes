...
DOCUMENTATION = '''
module: k8s_v1_security_context_constraints_list
short_description: Kubernetes SecurityContextConstraintsList
description:
      ...
      contains:
        ...
        priority:
          ...
          - Priority influences the sort order of SCCs when evaluating which SCCs
            ...
            Groups fields. The higher the int, the higher priority. If scores for
        ...
        volumes:
          ...
          - Volumes is a white list of allowed volume plugins. FSType corresponds
            ...
            emptyDir). To allow all volumes you may use '*'.
          type: list
          contains: str
    kind:
      description:
