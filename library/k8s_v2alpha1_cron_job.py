...
cron_job:
  ...
  contains:
    ...
    spec:
      description:
      - Spec is a structure defining the expected behavior of a job, including the
        schedule.
      type: complex
      contains:
        concurrency_policy:
          ...
          contains:
            ...
            spec:
              ...
              contains:
                ...
                selector:
                  description:
                  - Selector is a label query over pods that should match the pod
                      ...
                      contains:
                        ...
                        containers:
                          ...
                          contains:
                            args:
                              description:
                              - "Arguments to the entrypoint. The docker image's CMD\
                            ...
                            command:
                              ...
                              - "Entrypoint array. Not executed within a shell. The\
                                \ docker image's ENTRYPOINT is used if this is not\
                                ...
                                \ will be unchanged. The $(VAR_NAME) syntax can be\
                            ...
                            termination_message_path:
                              ...
                              - "Optional: Path at which the file to which the container's\
                                ...
                                \ message. Defaults to /dev/termination-log. Cannot\
                                \ be updated."
                              type: str
                            tty:
                              description:
                          ...
                          contains:
                            fs_group:
                              ...
                              - "A special supplemental group that applies to all\
                                ...
                                \ Kubelet to change the ownership of that volume to\
                                \ be owned by the pod: 1. The owning GID will be the\
                                \ FSGroup 2. The setgid bit is set (new files created\
                                \ in the volume will be owned by FSGroup) 3. The permission\
                                \ bits are OR'd with rw-rw---- If unset, the Kubelet\
                              ...
                              contains:
                                ...
                                items:
                                  ...
                                  - If unspecified, each key-value pair in the Data
                                    ...
                                    the volume setup will error. Paths must be relative
