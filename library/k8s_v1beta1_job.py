...
options:
  ...
  spec_auto_selector:
    description:
    - AutoSelector controls generation of pod labels and pod selectors. It was not
      present in the original extensions/v1beta1 Job definition, but exists to allow
      conversion from batch/v1 Jobs, where it corresponds to, but has the opposite
  ...
  contains:
    ...
    spec:
      ...
      contains:
        ...
        auto_selector:
          description:
          - AutoSelector controls generation of pod labels and pod selectors. It was
            not present in the original extensions/v1beta1 Job definition, but exists
            to allow conversion from batch/v1 Jobs, where it corresponds to, but has
            the opposite meaning as, ManualSelector.
          type: bool
        completions:
          description:
          - Completions specifies the desired number of successfully finished pods
            the job should be run with. Setting to nil means that the success of any
            pod signals the success of all pods, and allows parallelism to have any
    ...
    status:
      ...
      contains:
        ...
        completion_time:
          description:
          - CompletionTime represents time when the job was completed. It is not guaranteed
