...
options:
  ...
  spec_progress_deadline_seconds:
    ...
    - The maximum time in seconds for a deployment to make progress before it is considered
      ...
      deployment status. Once autoRollback is implemented, the deployment controller
      will automatically rollback failed deployments. Note that progress will not
      be estimated during the time a deployment is paused. This is not set by default.
    aliases:
              ...
              contains:
                ...
                max_unavailable:
                  ...
                  - 'The maximum number of pods that can be unavailable during the
                    ...
                    percentage by rounding up. This can not be 0 if MaxSurge is 0.
                    By default, a fixed value of 1 is used. Example: when this is
                    ...
                    ready, old RC can be scaled down further, followed by scaling
