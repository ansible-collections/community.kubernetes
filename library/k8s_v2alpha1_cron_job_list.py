      ...
      contains:
        ...
        spec:
          ...
          contains:
            concurrency_policy:
              description:
              - ConcurrencyPolicy specifies how to treat concurrent executions of
                a Job.
              type: str
            job_template:
              description:
              ...
              contains:
                ...
                spec:
                  ...
                  contains:
                    ...
                    parallelism:
                      description:
                      - Parallelism specifies the maximum desired number of pods the
                          ...
                          contains:
                              ...
                              contains:
                                ...
                                termination_message_path:
                                  ...
                                  - "Optional: Path at which the file to which the\
                                    ...
                                    \ Defaults to /dev/termination-log. Cannot be\
                                    \ updated."
                                  type: str
                                tty:
                                  description:
                            ...
                            dns_policy:
                              ...
                              - Set DNS policy for containers within the pod. One
                                of 'ClusterFirst' or 'Default'. Defaults to "ClusterFirst".
                              type: str
                            host_ipc:
                              description:
                              ...
                              contains:
                                fs_group:
                                  ...
                                  - "A special supplemental group that applies to\
                                    \ all containers in a pod. Some volume types allow\
                                    \ the Kubelet to change the ownership of that\
                                    \ volume to be owned by the pod: 1. The owning\
                                    \ GID will be the FSGroup 2. The setgid bit is\
                                    \ set (new files created in the volume will be\
                                    \ owned by FSGroup) 3. The permission bits are\
                                    \ OR'd with rw-rw---- If unset, the Kubelet will\
                                    \ not modify the ownership and permissions of\
                                    \ any volume."
                                  type: int
                                run_as_non_root:
                                  description:
                              ...
                              contains:
                                  ...
                                  contains:
                                    ...
                                    items:
                                      ...
                                      - If unspecified, each key-value pair in the
                                        ...
                                        volume setup will error. Paths must be relative
                                ...
                                iscsi:
                                  ...
                                  contains:
                                    ...
                                    iscsi_interface:
                                      description:
                                      - "Optional: Defaults to 'default' (tcp). iSCSI\
                                        \ interface name that uses an iSCSI transport."
                                      type: str
                                    lun:
                                      description:
                                  ...
                                  contains:
                                    ...
                                    items:
                                      ...
                                      - If unspecified, each key-value pair in the
                                        ...
                                        setup will error. Paths must be relative and
        ...
        status:
          ...
          contains:
            ...
            last_schedule_time:
              description:
              - LastScheduleTime keeps information of when was the last time the job
